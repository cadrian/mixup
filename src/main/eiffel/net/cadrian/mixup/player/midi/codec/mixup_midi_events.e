...
feature {ANY}
   controller_event (channel: INTEGER_32; knob: MIXUP_MIDI_CONTROLLER_KNOB; value: INTEGER): MIXUP_MIDI_EVENT
      require
   ...
   program_change_event (channel: INTEGER_32; patch: INTEGER_32): MIXUP_MIDI_EVENT
      require
         channel.in_range(0, 15)
         patch >= 0
      do
   ...
   note_event (channel: INTEGER_32; on_off: BOOLEAN; pitch: INTEGER_32; velocity: INTEGER_32): MIXUP_MIDI_EVENT
      require
         channel.in_range(0, 15)
      do
         if on_off then
   ...
   pitch_bend_event (channel: INTEGER_32; pitch: INTEGER): MIXUP_MIDI_EVENT
      require
         channel.in_range(0, 15)
   ...
   channel_pressure_event (channel: INTEGER_32; pressure: INTEGER_32): MIXUP_MIDI_EVENT
      require
         channel.in_range(0, 15)
         pressure >= 0
      do
   ...
   key_pressure_event (channel: INTEGER_32; key: INTEGER_32; pressure: INTEGER_32): MIXUP_MIDI_EVENT
      require
         channel.in_range(0, 15)
         key >= 0
         pressure >= 0
