...
--
class MIXUP_TRANSFORM_SEQUENCER
...
feature {}
   make (a_on_event: like on_event; a_input: MIXUP_MIDI_FILE)
      require
         a_on_event /= Void
         a_input /= Void
      do
   ...
   on_event: FUNCTION[TUPLE[MIXUP_MIDI_CODEC], MIXUP_MIDI_CODEC]
...
end -- class MIXUP_TRANSFORM_SEQUENCER
