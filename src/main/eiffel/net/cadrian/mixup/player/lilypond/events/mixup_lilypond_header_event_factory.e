...
--
class MIXUP_LILYPOND_HEADER_EVENT_FACTORY
...
create {MIXUP_LILYPOND_PLAYER, MIXUP_LILYPOND_HEADER_EVENT_FACTORY}
   make
...
feature {ANY}
   ...
   out_in_tagged_out_memory is
      do
         tagged_out_memory.append(once "{MIXUP_LILYPOND_HEADER_EVENT_FACTORY %"")
...
feature {ANY}
   ...
   new_events_iterator (a_context: MIXUP_EVENTS_ITERATOR_CONTEXT): MIXUP_EVENTS_ITERATOR is
      do
         create {MIXUP_SINGLE_EVENT_ITERATOR} Result.make(create {MIXUP_LILYPOND_HEADER_EVENT}.make(a_context.event_data(source), string))
      end
...
feature {MIXUP_EXPRESSION, MIXUP_IDENTIFIER_PART}
   as_name_in (a_name: STRING) is
      do
         a_name.append(once "<header_event>")
      end

invariant
   string /= Void

end -- class MIXUP_LILYPOND_HEADER_EVENT_FACTORY
