...
feature {MIXUP_PLAYER}
   fire (player: MIXUP_PLAYER)
      local
         p: MIXUP_EVENT_START_SLUR_PLAYER
      do
         p ::= player
         p.play_start_slur(data, xuplet_numerator, xuplet_denominator, text)
      end

feature {}
   make (a_data: like data; a_xuplet_numerator: INTEGER_64; a_xuplet_denominator: INTEGER_64; a_text: ABSTRACT_STRING)
      require
         a_text /= Void
      do
         make_(a_data)
...
end -- class MIXUP_EVENT_START_SLUR
